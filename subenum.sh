...
cd ~/results/$host
jsubfinder -f hhhhhh -s -c 40 -crawl -o jsub_$host -g | tee -a domains_$host
...
# echo "Getting valid resolver's from public-dns.info" 
# dnsvalidator -tL https://public-dns.info/nameservers.txt -threads 50 -o ~/tools/resolvers1 --silent
# dnsvalidator -tL https://wordlists-cdn.assetnote.io/data/manual/best-dns-wordlist.txt  -threads 50 -o ~/tools/resolvers2 --silent
# cd ~/tools/
# cat resolvers1 resolvers2 >> resolversall
